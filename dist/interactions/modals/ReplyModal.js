import { ActionRowBuilder, ButtonBuilder, ButtonStyle, DiscordAPIError, EmbedBuilder, MessageFlags, } from "discord.js";
import { generateAnonymousId, getRandomColor, } from "../../utils/helpers/confessionHelper.js";
import { getConfessionMessageId, getNextConfessionId, logConfession, } from "../../utils/managers/confessionManager.js";
export default {
    ...
    async execute(interaction) {
        ...
        try {
            ...
            console.log(`Logged reply #${newReplyId} with message ID ${sentMessage.id} by user ${interaction.user.tag}`);
            await interaction.deferUpdate();
        }
        catch (error) {
            console.error(`Error processing reply to confession #${targetId}:`, error);
