...
export const getMockUpdateData = (scenarioName) => {
    const scenarioKey = scenarioName && mockScenarios[scenarioName] ? scenarioName : "normal";
...
export const parseMockGitUpdateOutput = (scenarioName) => {
    ...
    return parseGitUpdateOutput(mockData.commitLog, mockData.pullStdout, mockData.fetchStderr);
};
