...
import { generateComponentsForTop, generateInitialTopReply, timeframeLabels, } from "../../../../utils/helpers/topHelper.js";
import { generateOverviewImage, } from "../../../../utils/services/imageGenerator.js";
import { getMockTopData } from "./top.mock.js";
export default createCommand("top", "サーバーランキングを表示する。Displays the server leaderboards.", async (interaction) => {
    ...
    if (isTestMode) {
        ...
        const imageBuffer = await generateOverviewImage(mockOverviewData, serverIconUrl, interaction.guild.name, timeframeLabel);
        ...
        const initialReply = await generateInitialTopReply(interaction.guild, interaction.client);
