...
export default createCommand("smite", "人に神罰を与える。Punish someone with the God's Wrath.", async (interaction, _client, options) => {
    ...
    await handleApprovalProcess(interaction, requiredApprovals, actionMessage, actionMessageEN, async (pollMessage) => {
        ...
        const command = Array(100)
            .fill(`execute at ${victimUsername} run summon minecraft:lightning_bolt ~ ~ ~`)
            .join("\n");
