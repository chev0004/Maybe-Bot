...
app.get("/leaderboard/msg-users", async (_req, res) => {
...
app.get("/leaderboard/vc-users", async (_req, res) => {
...
app.get("/leaderboard/stream-users", async (_req, res) => {
...
app.get("/leaderboard/bump-users", async (_req, res) => {
...
app.get("/leaderboard/msg-channels", async (_req, res) => {
...
app.get("/leaderboard/vc-channels", async (_req, res) => {
...
app.get("/activity/message", async (_req, res) => {
...
app.get("/activity/voice", async (_req, res) => {
