...
export const generateComponentsForTop = ({ category, timeframe, showTimeframeButtons, isTestMode = false, }) => {
    ...
    const dropdown = new StringSelectMenuBuilder()
        .setCustomId(`top-category-${timeframe}-${showTimeframeFlag}-${testModeFlag}`)
    ...
    if (showTimeframeButtons) {
        const timeButtons = new ActionRowBuilder().addComponents(new ButtonBuilder()
            .setCustomId(`top-timeframe-back-${category}-${timeframe}-${testModeFlag}`)
        ...
        const actionButtons = new ActionRowBuilder().addComponents(new ButtonBuilder()
            .setCustomId(`top-timeframe-show-${category}-${timeframe}-${testModeFlag}`)
