...
export const activityInteractionConfig = {
    prefix: "activity",
    categoryOptions: [
...
export const generateComponentsForActivity = ({ category, timeframe, showTimeframeButtons, isTestMode = false, }) => buildComponents(activityInteractionConfig, {
    category,
    timeframe,
