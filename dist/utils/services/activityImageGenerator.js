 ...
 */
const drawChartBase = async (ctx, hourlyData, serverName, serverIconUrl, timeframeLabel) => {
    await drawHeaderAndFooter(ctx, CANVAS_WIDTH, CANVAS_HEIGHT, serverIconUrl, serverName, "サーバーアクティビティ", timeframeLabel);
    // --- Draw Chart Area ---
...
function drawBars(ctx, hourlyData) {
    ...
    for (let i = 0; i < 24; i++) {
        ...
        drawRoundedRect(ctx, x + barMargin, y, barWidth - barMargin * 2, barHeight, 3);
    }
}
/**
 ...
 */
function drawLegendBox(ctx, stats) {
