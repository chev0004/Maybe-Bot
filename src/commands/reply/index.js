...
import { getConfessionData, getNextConfessionId, logConfession } from "../../utils/confessionManager.js"; 
...
export default {
  ...
  async execute(interaction) {
    ...
    try {
      ...
      const originalAuthorName = titleMatch ? titleMatch[1].trim() : originalEmbed.title;
